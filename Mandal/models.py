...
class MandalProfile(models.Model):
    ...
    Nirikshak = models.ForeignKey('Yuvak.YuvakProfile', on_delete=models.DO_NOTHING, related_name="nirikshak",
                                  blank=True, null=True)
    Sanchalak = models.ForeignKey('Yuvak.YuvakProfile', on_delete=models.DO_NOTHING, related_name="sanchalak",
                                  blank=True, null=True)
